...
merge_linters!(CompoundNominals => GeneralCompoundNominals, ImpliedOwnershipCompoundNominals => "Detects compound nouns split by a space and suggests merging them when both parts form a valid noun." );
