...
use general_compound_nominals::GeneralCompoundNominals;
use implied_action_compound_nominals::ImpliedActionCompoundNominals;
use implied_ownership_compound_nominals::ImpliedOwnershipCompoundNominals;

merge_linters!(CompoundNominals => GeneralCompoundNominals, ImpliedOwnershipCompoundNominals, ImpliedActionCompoundNominals => "Detects compound nouns split by a space and suggests merging them when both parts form a valid noun." );

#[cfg(test)]
mod tests {
    use super::CompoundNominals;
    ...
    fn web_cam() {
        ...
        assert_suggestion_result(test_sentence, CompoundNominals::default(), expected);
    }
    ...
    fn got_is_not_possessive() {
        assert_lint_count("I got here by car...", CompoundNominals::default(), 0);
    }
    ...
    #[test]
    fn allow_issue_661() {
        assert_lint_count("I may be wrong.", CompoundNominals::default(), 0);
    }
