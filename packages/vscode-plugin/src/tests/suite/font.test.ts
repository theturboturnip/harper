...
describe('Font >', () => {
    it('font file is included in extension package', async () => {
        ...
        try {
            ...
            throw new Error(`Media directory not found at ${mediaPath}. This indicates that the media directory may not have been properly included in the extension package.`);
        }
        ...
        try {
            ...
            throw new Error(`Font file not found at ${fontPath}. This indicates that the font file may not have been properly included in the extension package.`);
        }
    });
});